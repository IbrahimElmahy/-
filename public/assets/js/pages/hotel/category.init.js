var WebServices = function () {
    ...
    const messages = {
        ...
        VIEW_SERVICE_INFO: gettext("Manage Services"),
        EDIT_CATEGORY_INFO: gettext("Edit category info"),
    };
            ...
            },
            {
                ...
                render: function (data, type, source) {
                    if (source['is_active'] === true) {
                        return `<a href="javascript:void(0)" class="action-icon" data-toggle="iframe-modal" data-url="/${DateTime.getLanguageCode()}/hpanel/services/?category=${source['id']}" data-title="${messages.VIEW_SERVICE_INFO}" data-width="100%" data-height="100%"> <i class="mdi mdi-24px mdi-clipboard-list-outline"></i></a><a href="javascript:void(0)" class="action-icon" data-toggle="iframe-modal" data-url="update/${source['id']}/" data-title="${messages.EDIT_CATEGORY_INFO}" data-width="100%" data-height="88%"> <i class="mdi mdi-24px mdi-file-edit-outline"></i></a><a href="javascript:void(0)" id="deactivate-object-modal" class="action-icon" data-url="${data}disable/"> <i class="mdi mdi-24px mdi-shield-off-outline"></i></a><a href="javascript:void(0);" id="delete-object-modal" class="action-icon" data-url="${data}"> <i class="mdi mdi-24px mdi-delete"></i> </a>`
                    } else {
