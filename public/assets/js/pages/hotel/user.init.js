        ...
        Table.renderServerTableView(dataTableElement, dataTableFilter, [
            ...
            },
            {
                ...
                render: function (data, type, source) {
                    if (type === "display") {
                        return `<a href="javascript:void(0)" class="text-body font-weight-semibold" data-toggle="iframe-modal" data-url="update/${source['user']['id']}/" data-title="${messages.EDIT_USER_INFO}" data-width="100%" data-height="100%">${data}</a>`
                    }
                },
            },
            {
                ...
                render: function (data, type, source) {
                    if (type === "display") {
                        return `<img src="${source['user']['image_url']}" alt="table-user" class="mr-2 rounded-circle"><a href="javascript:void(0)" class="text-body font-weight-semibold" data-toggle="iframe-modal" data-url="update/${source['user']['id']}/" data-title="${messages.EDIT_USER_INFO}" data-width="100%" data-height="100%">${data}</a>`
                    }
                },
            },
            {
