var WebServices = function () {
    ...
    const messages = {
        ...
        EDIT_PAYMENT_METHOD_INFO: gettext("Edit payment method info"),
    };
    ...
    var renderViewWebServices = function () {
        Table.renderServerTableView(dataTableElement, dataTableFilter, [
            ...
            {
                data: 'requires_transaction_number',
                render: function (data) {
                    return `<div class="checkbox checkbox-primary checkbox-single"> <input type="checkbox" id="requires_transaction_number" value="requires_transaction_number" ${data ? "checked" : ""} disabled=""><label></label></div>`
                },
