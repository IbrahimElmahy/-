...
!function ($) {
    ...
    LeftSidebar.prototype._reset = function () {
        ...
        LeftSidebar.prototype.changeSidebarTogglerIcon = function (size) {
            $("#sidebar-toggler").removeClass();
            // the chevrons direction will be changed based on 
            // the sidebar size and document direction (rtl/ltr)
            var dir = $("html").attr('dir');

            if (size === undefined || size === null) {
                size = this.parent.config.sidebar.size;
            }
            
            if (size === 'default') {
                $("#sidebar-toggler").addClass(
                    dir === "ltr" ? "mdi mdi-chevron-double-left" : "mdi mdi-chevron-double-right"
                );
            } else {
                $("#sidebar-toggler").addClass(
                    dir === "ltr" ? "mdi mdi-chevron-double-right" : "mdi mdi-chevron-double-left"
                );
            }
        },
        ...
        LeftSidebar.prototype.changeSize = function (size) {
            ...
            this.changeSidebarTogglerIcon(size);
        },
        ...
        LeftSidebar.prototype.initMenu = function () {
            ...
            self.changeSidebarTogglerIcon();
            
            $("#sidebar-toggler").on('click', function (e) {   
                var sidebarSize = self.parent.config.sidebar.size;
        ...
        LeftSidebar.prototype.init = function () {
            var self = this;
            this.initMenu();
            // this method overrides the user configs of the sidebar menu
            //this.initLayout();
    ...
    function ($) {
        ...
        LayoutThemeApp.prototype._saveConfig = function (newConfig) {
            ...
            if (this.body.hasClass('dashboard-layout')) {
                var config = JSON.stringify(this.config);
                localStorage.setItem('config', config);
                // update the data-layout attr with the new config
                this.body.attr('data-layout', config);
            }
        },
        ...
        LayoutThemeApp.prototype.loadConfig = function () {
            ...
            var bodyConfig = this.body.attr('data-layout') ? this.body.attr('data-layout') : '{}';

            if (localStorageConfig) {
               return $.extend(true, {}, defaultConfig, JSON.parse(localStorageConfig));
            } else {
                return $.extend(true, {}, defaultConfig, bodyConfig);
            }
        },
