                ...
                processPath = function (path, d, pcom) {
                    ...
                    switch (path[0]) {
                        ...
                        case "A":
                            ...
                            break;
                        case "S":
                            if (pcom == "C" || pcom == "S") { // In "S" case we have to take into user, if the previous command is C/S.
                            ...
                            break;
                        case "T":
                            if (pcom == "Q" || pcom == "T") { // In "T" case we have to take into user, if the previous command is Q/T.
